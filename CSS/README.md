...
CSS (Cascading Style Sheets) är det som ger en webbsida design, färger och layout. Det förvandlar ren HTML till visuellt tilltalande webbsidor.

![CSS Exempel](./CSS_Example.png)

## Vad är CSS?

- **CSS** står för Cascading Style Sheets
- **Beskriver** hur HTML-element ska visas på skärmen, på papper eller i andra media
- **Sparar arbete** - kan styra layouten på flera sidor samtidigt
- **Externa formatmallar** lagras i separata CSS-filer för bättre organisation
...
2. [CSS Selectorer](#2-css-selectorer)
3. [CSS Olika sätt](#3-css-olika-sätt)
4. [CSS Färger](#4-css-färger)
5. [CSS Bakgrunder](#5-css-backgrounds-bakgrunder)
6. [CSS Ramar](#6-css-borders-ramar)
7. [CSS Marginaler](#7-css-margins-marginaler)
8. [CSS Utfyllnad](#8-css-padding-utfyllnad)
9. [CSS Höjd/Bredd](#9-css-heightwidth)
10. [CSS Box Model](#10-css-box-model)
11. [CSS Text](#11-css-text)
12. [CSS Typsnitt](#12-css-font-typsnitt)
13. [CSS Länkar](#13-css-links-länkar)
14. [CSS Display](#14-css-display)
15. [CSS Position](#15-css-position)
16. [CSS Combinators](#16-css-combinators)
17. [CSS Flexbox](#17-css-flexbox)
...
Flexbox är en modern layoutmodul som gör det enkelt att skapa flexibla och responsiva layouts.

### Vad är Flexbox?

Före Flexbox fanns fyra huvudsakliga layoutlägen:

- **Block** - för sektioner på en webbsida
- **Inline** - för text
- **Tabell** - för tvådimensionella tabelldata
- **Positionering** - för exakt positionering av element
...
Nu har du en komplett översikt över CSS grunderna! Börja med syntax och selectorer, arbeta dig genom box model, och avsluta med moderna layouttekniker som Flexbox. Kom ihåg att praktisera regelbundet och experimentera med olika egenskaper.
